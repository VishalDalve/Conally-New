...
import com.app.coinally.in.Bittrex.activities.GetCurrenciesActivity;
import com.app.coinally.in.Bittrex.models.RequestActivity;
...
public class RequestActivityAdapter extends SelectableAdapter<RequestActivityAdapter.ViewHolder, RequestActivity<?>> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.btx_item_requestactivity, parent, false));
    }
